...
function App() {
  ...
  return <main className="shell">
    <header className="topbar"><div><span className="mark">BLEACHERS</span><span className="live-label">{isPublisher ? 'PUBLISHER' : game?.status === 'live' ? 'LIVE' : 'WAITING FOR GAME'}</span></div><span className="privacy">PRIVATE GAME</span></header>
